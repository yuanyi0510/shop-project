                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                    	<div  class="dataTables_wrapper form-inline" role="grid">
                    		<!-- 查询条件 -->
	                    	<form  id="searchForm" method="post" action="/shop-admin/activity/toactivity">
		                    	<div class="row">
		                    		<div class="col-sm-2">
		                    			<div class="dataTables_length">
		                    				<a href="/shop-admin/activity/toupdate" class="btn btn-primary ">发布活动</a>
		                    			</div>
		                    		</div>
		                    		<div class="col-sm-7">
	                        ...
	                        <table class="table table-striped table-bordered table-hover dataTables-example">
	                            ...
	                            <c:forEach items="${list }" var="a">
	                            	<tr class="gradeA">
			                                 ...
			                                 <td>
			                                 	<a href="/shop-admin/activity/toupdate?id=${a.id}"><i style="margin-left:5px;" class="fa fa-edit"></i></a>
	...
	<script type="text/javascript">
		...
		function delActivity(id) {
			  swal({
			    	...
			    	$.post("/shop-admin/activity/delActivity?id="+id,function(data){
						if(data=='success'){
							swal({
				                   title: "删除成功！",
				                   text: "您已经永久删除了这条信息。",
